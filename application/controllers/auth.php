...
class Auth extends CI_Controller {
	...
	function index()
	{
		...
		elseif (!$this->ion_auth->is_admin()) // remove this elseif if you want to enable this for non-admins
		{
			...
			return show_error('Трябва да имате администраторски права, за да видите тази страница.');
		}
		else
		{
			// set the flash data error message if there is one
			$this->data['title'] = "Админ панел";
	...
	{
		$this->data['title'] = "Забравена парола";
    ...
    {
        $this->data['title'] = "Създаване на потребител";
